...
import DemoRolePicker from "@/components/demo/DemoRolePicker";
    ...
    return (
        <div className="relative min-h-screen bg-slate-950 text-white overflow-hidden">
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-16 sm:px-8">
                <div className="w-full max-w-4xl rounded-[32px] border border-white/10 bg-white/95 p-8 shadow-2xl sm:p-10">
                    <DemoRolePicker />
                </div>
            </div>
        </div>
